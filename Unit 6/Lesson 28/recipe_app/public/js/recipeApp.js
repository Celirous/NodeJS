...
let addJoinButtonListener = () => {
  $(".join-button").click(event => { //Create the event listener for the modal button.
    ...
    $.get(`/api/courses/${courseId}/join?apiToken=recipeT0k3n`, (results = {}) => { // this will now make a get request to the course using the id, then we make an empty object called results and save it in there 
