...
module.exports = {
  ...
  saveSubscriber: async (req, res, next) => {
    try {
      ...
      console.log(
        `Here is all your contacts for the console log: ${newSubscriber}`
      );
      res.render("thanks");
    } catch (error) {
  ...
  update: async (req, res, next) => {
    ...
    try {
      ...
      res.locals.subscriber = subscriber;
      console.log(`subscriberParams After: ${subscriberParams.name}, ${subscriberParams.email}, ${subscriberParams.zipCode}`);
      next();
    } catch (error) {
